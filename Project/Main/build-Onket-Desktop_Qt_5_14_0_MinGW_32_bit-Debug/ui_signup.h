...
"color: rgb(0, 0, 0);"));
        ...
        layoutWidget1 = new QWidget(signup_second_step);
        layoutWidget1->setObjectName(QString::fromUtf8("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(600, 440, 361, 101));
        verticalLayout_2 = new QVBoxLayout(layoutWidget1);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        firstname_is_empty = new QLabel(layoutWidget1);
        ...
        lastname_is_empty = new QLabel(layoutWidget1);
        ...
        phone_is_empty = new QLabel(layoutWidget1);
        ...
        no_address = new QLabel(layoutWidget1);
